...
class FYCM extends StatefulWidget {
  @override
  _FYCMState createState() => _FYCMState();
}

class _FYCMState extends State<FYCM> {
  var subjects = [
    "Select Subject",
            ...
            Row(children: <Widget>[
                  ...
                  if (selected != "Select Subject") {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) =>
                            Attendance(_, _date, selected,"FYCM1")));
                  } else {
                    showDialog(
                      context: context,
                      builder: (BuildContext context) {
              ...
              RaisedButton(
                ...
                onPressed: () async {
                  ...
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (BuildContext context) =>
                          Attendance(_, _date, selected,"FYCM2")));
                },
              )
            ]),
            SizedBox(height: 55),
