...
class SYCM extends StatefulWidget {
  @override
  _SYCMState createState() => _SYCMState();
}

class _SYCMState extends State<SYCM> {
  var subjects = [
    "Select Subject",
            ...
            Row(children: <Widget>[
                  ...
                  if (selected != "Select Subject") {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) =>
                            Attendance(_, _date, selected,"SYCM1")));
                  } else {
                    showDialog(
                      context: context,
                      builder: (BuildContext context) {
              ...
              RaisedButton(
                ...
                onPressed: () async {
                  ...
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (BuildContext context) =>
                          Attendance(_, _date, selected,"SYCM2")));
                },
              )
            ]),
            SizedBox(height: 55),
